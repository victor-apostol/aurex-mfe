const NotFoundPage = () => (
  <div className="min-h-screen bg-[#F7F3EE] flex items-center justify-center px-4">
    <div className="text-center max-w-md">
      <p className="font-serif text-[120px] font-medium text-[#0D1B2A]/5 leading-none mb-0 select-none">404</p>
      ...
      <p className="text-xs tracking-[0.2em] uppercase text-[#C9A96E] mb-4">Page not found</p>

      <h1 className="font-serif text-4xl font-medium text-[#0D1B2A] mb-4">Nothing here</h1>
